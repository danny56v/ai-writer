...
const features = [
  {
    ...
    description:
      "Collect property specs, brand voice, and compliance notes in one structured form. ScriptNest transforms context into polished copy instantly.",
...
const faqs = [
  {
    question: "Can ScriptNest replace our human writers?",
    answer:
      "We position AI as a creative copilot. You keep full editorial control with approvals, team roles, and audit logs for every draft.",
  },
  {
    question: "How do plan limits reset?",
    answer:
      "Free accounts refresh the first day of every month. Paid subscriptions reset based on your Stripe billing cycle so credits match your invoices.",
  },
  {
    question: "Do you support multi-brand organisations?",
    answer:
      "Yes. Workspaces manage separate brand voices, tone guides, and asset libraries so agencies and franchises stay consistent.",
  },
];
...
const uspHighlights = [
  {
    ...
    description: "Agents ship MLS-ready descriptions in minutes, not hours, with localised tone and compliance prompts.",
  },
  {
    title: "Scale long-form content",
    description: "Marketing teams craft newsletters, blog posts, and nurture flows with reusable briefs and AI-assisted rewrites.",
  },
  {
    title: "Keep billing transparent",
    description: "Stripe-powered portal lets admins manage seats, update payment methods, and view usage before each renewal.",
  },
];

const testimonials = {
  quote:
    "ScriptNest cut our listing turnaround time by 60%. Agents now focus on storytelling while AI keeps compliance in check.",
  name: "Laura Mitrea",
  ...
  return (
    <div className="rounded-3xl border border-indigo-100 bg-white shadow-2xl shadow-indigo-200/40">
      <div className="flex items-center gap-2 border-b border-indigo-100 px-6 py-4">
        ...
        <p className="ml-auto text-xs font-semibold text-indigo-500">ScriptNest Workspace</p>
      </div>
      <div className="grid gap-6 px-6 py-6 sm:grid-cols-2">
        ...
        <div className="rounded-2xl border border-indigo-100 bg-gradient-to-br from-white via-indigo-50/70 to-white p-6 text-sm text-gray-700">
          ...
          <p className="mt-3 leading-6">
            Welcome home to skyline living in the heart of the city. This sun-soaked loft pairs soaring 12-foot
            ceilings with industrial touches and a chef-ready kitchen. Step onto your private balcony for sunset views,
            or head downstairs to cafés, boutique gyms, and the light-rail just one block away.
          </p>
          <p className="mt-3 leading-6">
...
export default function LandingPage() {
  return (
    <div className="bg-white text-gray-900">
      <main className="isolate">
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                ScriptNest connects your briefs, brand voice, and AI assistants in one workspace. Produce consistent
        ...
        <section id="features" className="mx-auto mt-32 max-w-7xl px-6 sm:mt-48 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              ScriptNest gives marketers and agents a shared workspace for briefs, AI drafts, revisions, and approvals.
              No more bouncing between docs, email, and chat threads.
            </p>
          </div>
        ...
        {/* Testimonial */}
        <section id="resources" className="mx-auto mt-32 max-w-7xl px-6 sm:mt-48 lg:px-8">
        ...
        <section id="pricing" className="py-24 sm:pt-48">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-gray-600">
              Start free, then upgrade when you are ready to onboard your teammates. Usage credits, billing portal,
              and invoices are handled automatically via Stripe.
            </p>
            <div className="mt-16">
        ...
        {/* FAQ */}
        <section className="mx-auto max-w-2xl divide-y divide-gray-900/10 px-6 pb-16 sm:pb-24 lg:max-w-5xl lg:px-8">
          <h2 className="text-2xl font-bold leading-10 tracking-tight text-gray-900">Frequently asked questions</h2>
          <dl className="mt-10 space-y-10 divide-y divide-gray-900/10">
            {faqs.map((faq) => (
              <div key={faq.question} className="pt-10 lg:grid lg:grid-cols-12 lg:gap-8">
                <dt className="text-base font-semibold leading-7 text-gray-900 lg:col-span-4">{faq.question}</dt>
                <dd className="mt-4 text-base leading-7 text-gray-600 lg:col-span-8 lg:mt-0">{faq.answer}</dd>
              </div>
            ))}
          </dl>
        </section>
        ...
        <section className="relative mt-32 px-6 pb-32 lg:px-8">
          ...
          <div className="mx-auto max-w-3xl rounded-3xl border border-indigo-100 bg-white p-10 text-center shadow-lg shadow-indigo-100/60">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
              Ready to see ScriptNest inside your workflow?
            </h2>
      ...
      <footer className="mx-auto mt-24 max-w-7xl px-6 pb-16 sm:mt-40 sm:pb-24 lg:px-8">
        <div className="grid gap-10 border-t border-gray-200 pt-12 sm:grid-cols-2 lg:grid-cols-4">
          <div className="flex flex-col gap-4">
            <Link href="/" className="flex items-center gap-2 text-gray-900">
              <Image src="/Logo.png" alt="ScriptNest" width={28} height={28} className="h-7 w-7" />
              <span className="text-sm font-semibold">ScriptNest</span>
            </Link>
            <p className="text-sm text-gray-500">
              AI tooling built for teams who care about brand voice, compliance, and measurable productivity.
            </p>
          </div>
          <div>
        ...
        <div className="mt-10 border-t border-gray-200 pt-6 text-xs text-gray-500">
          © {new Date().getFullYear()} ScriptNest. All rights reserved.
        </div>
      </footer>
    </div>
  );
