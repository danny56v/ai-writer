  ...
  return (
    <form className="space-y-8" action={formAction}>
      <div className="grid gap-6">
          ...
          {[{ key: "sale", label: "Sale" }, { key: "rent", label: "Rent" }].map((opt) => (
            <button
              ...
              className={cx(
                ...
                listingType === opt.key
                  ? "border-purple-400 bg-gradient-to-r from-purple-600 via-fuchsia-500 to-amber-400 text-white shadow-lg shadow-fuchsia-400/40"
                  : "border-slate-200/80 bg-white/90 text-slate-700 shadow-inner shadow-white/60 hover:border-purple-200"
              )}
            >
              {opt.label}
            </button>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            ...
            <input
              ...
              min={0}
              placeholder="e.g., 75"
              className="mt-2 h-11 w-full rounded-2xl border border-slate-200/80 bg-white/90 px-3 text-sm font-medium text-slate-700 placeholder:text-slate-400 focus:border-purple-400 focus:outline-none focus:ring-4 focus:ring-purple-200/60"
            />
          </div>
          <div>
        ...
        <fieldset className="grid gap-4 rounded-3xl border border-slate-200/70 bg-white/80 p-6">
      ...
      <div className="flex flex-wrap justify-end gap-3">
        <button
          type="reset"
          className="rounded-full border border-slate-200 bg-white/80 px-5 py-2 text-sm font-semibold text-slate-600 shadow-inner shadow-white/60 transition hover:border-purple-200 hover:text-purple-600"
          onClick={() => {
        ...
        <button
          type="submit"
          disabled={pending}
          className="inline-flex items-center justify-center rounded-full bg-gradient-to-r from-purple-600 via-fuchsia-500 to-amber-400 px-6 py-2 text-sm font-semibold text-white shadow-lg shadow-fuchsia-400/40 transition hover:opacity-95 disabled:cursor-not-allowed disabled:opacity-60"
        >
