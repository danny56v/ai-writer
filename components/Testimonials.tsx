...
export default function Testimonials() {
  return (
    <section className="relative mt-24 overflow-hidden rounded-3xl border border-white/80 bg-gradient-to-br from-slate-900 via-slate-950 to-slate-900 px-6 py-20 shadow-soft-xl sm:px-10 lg:px-16">
      <div className="absolute -left-24 top-12 h-56 w-56 rounded-full bg-purple-500/40 blur-3xl" aria-hidden="true" />
      <div className="absolute -right-28 bottom-0 h-72 w-72 rounded-full bg-fuchsia-500/30 blur-3xl" aria-hidden="true" />
      <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-[0.08]" aria-hidden="true" />
