      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-lg">
        <div className="rounded-3xl bg-white px-6 py-10 shadow sm:px-12">
          <p className="text-sm text-gray-600">
            Check your inbox (and spam/promotions) for the ScriptNest message. Click the button inside the email within
          ...
          <div className="mt-6 space-y-3 text-sm text-gray-600">
            ...
            <p>
              Already confirmed? <Link href="/sign-in" className="font-semibold text-indigo-600 hover:text-indigo-500">Sign in here</Link>.
            </p>
          </div>
        </div>
      </div>
