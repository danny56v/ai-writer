...
export const metadata: Metadata = {
  title: "Pricing to turn addresses into listing descriptions | ListologyAi",
  description:
    "Compare ListologyAi plans that let you drop a property address and receive a polished listing description in seconds—built for agents who want faster property copy.",
